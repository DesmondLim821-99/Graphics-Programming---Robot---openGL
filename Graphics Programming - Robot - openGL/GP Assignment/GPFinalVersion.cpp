...
float lx = 1.5, lz = 0.0, lspeed = 0.1;

float amb[] = { 1.0, 1.0, 1.0 };	//Red Color
float ambHead[] = { 1.0, 0.27, 0.0 };
float ambLegPlate[] = { 1.0, 0.0, 0.0 };
float ambLightBlue[] = { 0.0, 0.74, 1.0 };
float ambBlack[] = { 0.0, 0.0, 0.0 };
float ambGrey[] = { 0.5, 0.5, 0.5 };
float pos[] = { lx, 0.5, lz };	// amb light pos (0,1,0) above 
float dif[] = { 1.0, 1.0, 1.0 };	// Green color diffuse light 
//float difM[] = { 0.99, 0.72, 0.07 };	// Red color diffuse Material
float difM[] = { 1.0, 1.0, 1.0 };	// Red color diffuse Material
...
LRESULT WINAPI WindowProcedure(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN: //Only call once when you press key
		...
		//else if (wParam == 0x32) { //press 2 for running
		...
		//	option = 4;
		//}
		//else if (wParam == 0x35) {                     // use Pistol 
		//	/*if (d == 0.0) {
		//		rShoulderRight -= rspeed;
		//	}*/
		//	option = 5;
...
void drawLeftArm() {
	...
	if (b == 1.0) {
		...
		glMaterialfv(GL_FRONT, GL_AMBIENT, ambGrey);
	...
	if (b == 1.0) {
		...
		glMaterialfv(GL_FRONT, GL_AMBIENT, ambHead);
	...
	glMaterialfv(GL_FRONT, GL_AMBIENT, ambLegPlate);
	...
	glMaterialfv(GL_FRONT, GL_AMBIENT, ambLightBlue);
...
void drawRightArm() {
	...
	glRotatef(90, 1.0, 0.0, 0.0);
	glColor3f(0.2, 0.2, 0.2);
	glMaterialfv(GL_FRONT, GL_AMBIENT, ambBlack);
	drawCylinder(0.04, 0.02, 0.4);  // Upper Limb Cylinder
	glPopMatrix();
